 ...
 */
public class LuceneIndexSearcher2 implements Index.Searcher, Closeable
{
    private static final Logger logger = LoggerFactory.getLogger(LuceneIndexSearcher2.class);
     ...
     */
    public LuceneIndexSearcher2(ColumnFamilyStore baseCfs, ColumnDefinition column, ReadCommand readCommand)
        throws IOException
    {
    ...
    public UnfilteredPartitionIterator search(ReadExecutionController executionController) {
        ...
        return new LuceneResultsIterator(searchResults, readCommand, controller, executionController);
    }
